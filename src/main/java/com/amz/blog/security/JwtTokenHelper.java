...
public class JwtTokenHelper {
    ...
    // Use the secure key generated by Keys.secretKeyFor(SignatureAlgorithm.HS512)
    private final javax.crypto.SecretKey secretKey = Keys.secretKeyFor(SignatureAlgorithm.HS512);
